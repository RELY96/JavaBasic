...
//-----------------------------------------------------------------------------//		
		// rint : 가장 가까운 정수를 double 로 반환 : 반올림 정수를 double로 반환
...
//-----------------------------------------------------------------------------//
		...
		// 오토 박싱(auto-boxing) : Wrapper 객체와 기본자료형 사이의 변환을 자동으로 수행
		// 객체라는 커다란 박스 Wrapper class에 int, double 등의 값을 담음
		Integer wrapI = a; // 소문자 자료형 int a가 대문자 자료형 Integer 로 자동 형변환됨
		Double wrapD = 123.456; // 소문자 자료형 double 이 객체형 double로 자동 형변환됨
