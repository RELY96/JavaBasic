...
public class Ex08_Big {
	...
	public static void main(String[] args) {
		...
		System.out.println("기본자료형의 최대정수 => " + Long.MAX_VALUE); // 롱의 맥시멈 밸류 19자리
		System.out.println("기본자료형의 최소정수 => " + Long.MIN_VALUE);
		long lnum = Long.MAX_VALUE;

		// 컴파일, 런타임 오류는 발생하지 않지만 결과는 틀림 => 논리적(Logical) 오류
		// => Overflow 발생 -> 최댓값의 오버플로우-최솟값
		lnum += 1;
		System.out.println("lnum => " + lnum);
		System.out.println("==========================================="); 

		BigInteger b1 = new BigInteger("12345678900000000000"); //오버플로우가 안 일어나게 하려면, long보다 큰 Big을 써줘야함! *BigInteger*
		...
		// ** Decimal : 1.십진법의 2.소수 -> 산술연산 적용불가, 연산하려면 add같은 매서드 이용해야함
